...
echo -e "${CYANBOLD}Building Go app for Windows 64:${RESET} ${GREENBOLD}GOOS=windows GOARCH=amd64 go build -ldflags "-X main.AppReleaseVersion=\$APPRELEASEVERSION" -o bin/golangbuildconcepts.exe .${RESET}"
